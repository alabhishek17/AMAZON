...
function DEVICES(){
    ...
    const { data: groceryData, error: groceryError, isLoading: isLoadinggrocery } = useGetProductsByCategoryQuery(
        "search?query=Amazon Devices&page=1&country=US&sort_by=RELEVANCE&product_condition=ALL"
      );
...
return(
    <div className="flex flex-wrap mb-10 flex-shrink-0 flex-grow-0 justify-center my-4">
            {groceryData.data.products.map((item,asin) => (
